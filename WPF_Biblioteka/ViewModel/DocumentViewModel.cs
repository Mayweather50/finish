    ...
    public class DocumentViewModel : INotifyPropertyChanged
    {
        ...
        public DocumentViewModel()
        {
            ObservableCollection<DocumentItems> documentItems = new ObservableCollection<DocumentItems>
            {
                ...
                new DocumentItems { DocumentName = "File", DocumentImage = @"Assets/file_icon.png" },
                new DocumentItems { DocumentName = "Printer", DocumentImage = @"Assets/printer_icon.png" },
                new DocumentItems { DocumentName = "Chart", DocumentImage = @"Assets/chart_icon.png" },
                new DocumentItems { DocumentName = "Calendar", DocumentImage = @"Assets/calendar_icon.png" },
                new DocumentItems { DocumentName = "Analytics", DocumentImage = @"Assets/analytics_icon.png" },
